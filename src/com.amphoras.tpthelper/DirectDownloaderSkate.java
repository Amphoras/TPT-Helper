...
public class DirectDownloaderSkate extends ListActivity {
  SharedPreferences preferences;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		dialog = new ProgressDialog(DirectDownloaderSkate.this);
	    ...
	    HashMap<String, Object> listitem;
              ...
              listitem = new HashMap<String, Object>();
	          listitem.put(tptname, "Skate TPT");
	...
	public void DownloadFile() {
		...
		switch (id) {
		case 0:
			task.execute(new String[] { "http://dl.dropbox.com/u/41652192/Skate%20TPTs/200sys-35cache-skate-tpt.zip" });
			break;
		case 1:
    ...
    protected Dialog onCreateDialog(int id) {
        switch (id) {
            ...
            case DOWNLOAD_COMPLETE:
            	...
            	Builder downloadbuilder = new AlertDialog.Builder(DirectDownloaderSkate.this);
            ...
            case DOWNLOAD_FAILED:
            	...
            	Builder downloadfailedbuilder = new AlertDialog.Builder(DirectDownloaderSkate.this);
            ...
            case FILE_FOUND:
            	...
            	Builder filetherebuilder = new AlertDialog.Builder(DirectDownloaderSkate.this);
            	...
            	filetherebuilder.setNegativeButton(R.string.no, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                    	DirectDownloaderSkate.this.finish();
                    }
                });
            ...
            case CHANGE_LOCALE:
              ...
              Builder localebuilder = new AlertDialog.Builder(DirectDownloaderSkate.this);
          	  ...
          	  localebuilder.setItems(locales, new DialogInterface.OnClickListener() {
          	    public void onClick(DialogInterface dialog, int item) {
          	    	...
          	    	case 0:
          	    		...
          	    		editlocale.commit();
          	    		Intent i = new Intent(DirectDownloaderSkate.this, HomeActivity.class);
          	    	    startActivity(i);
          	    	    DirectDownloaderSkate.this.finish();
          	    		break;
          	    	case 1:
          	    		...
          	    		editlocale.commit();
          	    		Intent j = new Intent(DirectDownloaderSkate.this, HomeActivity.class);
          	    	    startActivity(j);
          	    	    DirectDownloaderSkate.this.finish();
          	    		break;
          	    	case 2:
          	    		...
          	    		editlocale.commit();
          	    		Intent k = new Intent(DirectDownloaderSkate.this, HomeActivity.class);
          	    	    startActivity(k);
          	    	    DirectDownloaderSkate.this.finish();
          	    		break;
          	    	case 3:
          	    		...
          	    		editlocale.commit();
          	    		Intent l = new Intent(DirectDownloaderSkate.this, HomeActivity.class);
          	    	    startActivity(l);
          	    	    DirectDownloaderSkate.this.finish();
          	    		break;
          	    	case 4:
          	    		...
          	    		editlocale.commit();
          	    		Intent m = new Intent(DirectDownloaderSkate.this, HomeActivity.class);
          	    	    startActivity(m);
          	    	    DirectDownloaderSkate.this.finish();
          	    		break;
          	    	case 5:
              ...
              break;
            case V9CUSTOM:
                Builder builder1 = new AlertDialog.Builder(DirectDownloaderSkate.this);
                ...
                break;
            case V8CUSTOM:
                Builder builder2 = new AlertDialog.Builder(DirectDownloaderSkate.this);
                ...
                break;
            case V8STOCK:
                Builder builder3 = new AlertDialog.Builder(DirectDownloaderSkate.this);
                ...
                break;
            case V7B:
                Builder builder4 = new AlertDialog.Builder(DirectDownloaderSkate.this);
                ...
                break;
            case V4:
                Builder builder5 = new AlertDialog.Builder(DirectDownloaderSkate.this);
                ...
                break;
            case REVERT:
                Builder builder6 = new AlertDialog.Builder(DirectDownloaderSkate.this);
                ...
                break;
            case CM71RC1:
                Builder builder8 = new AlertDialog.Builder(DirectDownloaderSkate.this);
                ...
                break;
            case GSFB24:
                Builder builder9 = new AlertDialog.Builder(DirectDownloaderSkate.this);
                ...
                break;
            case GSFB23:
                Builder builder10 = new AlertDialog.Builder(DirectDownloaderSkate.this);
                ...
                break;
            case GSFB19:
                Builder builder11 = new AlertDialog.Builder(DirectDownloaderSkate.this);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.locale:
			...
			break;
		case R.id.about:
			Intent j = new Intent(DirectDownloaderSkate.this, About.class);
			startActivity(j);
			break;
		case R.id.instructions:
			Intent k = new Intent(DirectDownloaderSkate.this, Instructions.class);
			startActivity(k);
			break;
		case R.id.show_changelog:
			Intent l = new Intent(DirectDownloaderSkate.this, Changelog.class);
			startActivity(l);
			break;
		case R.id.preferences:
			Intent m = new Intent(DirectDownloaderSkate.this, Preferences.class);
			startActivity(m);
			break;
		case R.id.license:
			Intent n = new Intent(DirectDownloaderSkate.this, License.class);
			startActivity(n);
			break;
		}
		return true;
