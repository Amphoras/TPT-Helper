...
public class Downloader extends ListActivity {
	...
	final File gen2160TPT = new File(dir, "Gen2-fastboot-160sys-tpt.zip");
	final File downloadgen2160TPT = new File(dir, "download/Gen2-fastboot-160sys-tpt.zip");
	final File gen2128TPT = new File(dir, "Gen2-fastboot-128sys-tpt.zip");
	final File downloadgen2128TPT = new File(dir, "download/Gen2-fastboot-128sys-tpt.zip");
	final File gen2stockTPT = new File(dir, "Gen2-fastboot-stock-tpt.zip");
	final File downloadgen2stockTPT = new File(dir, "download/Gen2-fastboot-stock-tpt.zip");
	...
	private final int GEN2CUSTOM = 101;
	private final int GEN2CUSTOMB = 102;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		dialog = new ProgressDialog(Downloader.this);
		...
		public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
			switch (position) {
		      case 1:
		    	  showDialog(GEN2CUSTOM);
			      break;
		      case 2:
		    	  showDialog(GEN2CUSTOMB);
				  break;
		      case 3:
	    ...
	    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
	    	...
	    	switch (position) {
	    	case 1:
	    		editdownload.putString("downloadpicked", "Gen2-fastboot-160sys-tpt.zip");
	    		editdownload.commit();
				editdownloadint.putInt("downloadint", 0);
	    		editdownloadint.commit();
	    		if (gen2160TPT.canRead() == true){
	    		    showDialog(FILE_FOUND);
	    		} else {
	    			if (downloadgen2160TPT.canRead() == true){
    	    	        showDialog(FILE_FOUND);
	    			} else {
	    				DownloadFile();
	    			}
	    		...
	    		break;
	    	case 2:
	    		editdownload.putString("downloadpicked", "Gen2-fastboot-128sys-tpt.zip");
	    		editdownload.commit();
				editdownloadint.putInt("downloadint", 1);
	    		editdownloadint.commit();
	    		if (gen2128TPT.canRead() == true){
	    			showDialog(FILE_FOUND);
	    		} else {
	    			if (downloadgen2128TPT.canRead() == true){
	    				showDialog(FILE_FOUND);
	    			} else {
	    				DownloadFile();
	    			}
	    		...
	    		break;
	    	case 3:
	    		editdownload.putString("downloadpicked", "Gen2-fastboot-stock-tpt.zip");
	    		editdownload.commit();
				editdownloadint.putInt("downloadint", 2);
	    		editdownloadint.commit();
	    		if (gen2stockTPT.canRead() == true){
	    			showDialog(FILE_FOUND);
	    		} else {
	    			if (downloadgen2stockTPT.canRead() == true){
	    				showDialog(FILE_FOUND);
	    			} else {
	    				DownloadFile();
	    			}
	...
	public void DownloadFile() {
		...
		switch (id) {
		case 0:
			task.execute(new String[] { "http://dl.dropbox.com/u/41652192/TPT%20Helper/Gen2-fastboot-160sys-tpt.zip" });
			break;
		case 1:
			task.execute(new String[] { "http://dl.dropbox.com/u/41652192/TPT%20Helper/Gen2-fastboot-128sys-tpt.zip" });
			break;
		case 2:
			task.execute(new String[] { "http://dl.dropbox.com/u/41652192/TPT%20Helper/Gen2-fastboot-stock-tpt.zip" });
			break;
		/*case 3:
    ...
    protected Dialog onCreateDialog(int id) {
        switch (id) {
            ...
            case DOWNLOAD_COMPLETE:
            	...
            	Builder downloadbuilder = new AlertDialog.Builder(Downloader.this);
            ...
            case DOWNLOAD_FAILED:
            	...
            	Builder downloadfailedbuilder = new AlertDialog.Builder(Downloader.this);
            ...
            case FILE_FOUND:
            	...
            	Builder filetherebuilder = new AlertDialog.Builder(Downloader.this);
            ...
            case CHANGE_LOCALE:
              ...
              Builder localebuilder = new AlertDialog.Builder(Downloader.this);
          	  ...
          	  localebuilder.setItems(locales, new DialogInterface.OnClickListener() {
          	    public void onClick(DialogInterface dialog, int item) {
          	    	...
          	    	case 0:
          	    		...
          	    		editlocale.commit();
          	    		Intent i = new Intent(Downloader.this, HomeActivity.class);
          	    	    startActivity(i);
          	    	    Downloader.this.finish();
          	    		break;
          	    	case 1:
          	    		...
          	    		editlocale.commit();
          	    		Intent j = new Intent(Downloader.this, HomeActivity.class);
          	    	    startActivity(j);
          	    	    Downloader.this.finish();
          	    		break;
          	    	case 2:
          	    		...
          	    		editlocale.commit();
          	    		Intent k = new Intent(Downloader.this, HomeActivity.class);
          	    	    startActivity(k);
          	    	    Downloader.this.finish();
          	    		break;
          	    	case 3:
          	    		...
          	    		editlocale.commit();
          	    		Intent l = new Intent(Downloader.this, HomeActivity.class);
          	    	    startActivity(l);
          	    	    Downloader.this.finish();
          	    		break;
          	    	case 4:
          	    		...
          	    		editlocale.commit();
          	    		Intent m = new Intent(Downloader.this, HomeActivity.class);
          	    	    startActivity(m);
          	    	    Downloader.this.finish();
          	    		break;
          	    	case 5:
          	    		...
          	    		editlocale.commit();
          	    		Intent n = new Intent(Downloader.this, HomeActivity.class);
          	    	    startActivity(n);
          	    	    Downloader.this.finish();
          	    		break;
          	    	case 6:
          	    		...
          	    		editlocale.commit();
          	    		Intent o = new Intent(Downloader.this, HomeActivity.class);
          	    	    startActivity(o);
          	    	    Downloader.this.finish();
          	    		break;
          	    	case 7:
          	    		...
          	    		editlocale.commit();
          	    		Intent p = new Intent(Downloader.this, HomeActivity.class);
          	    	    startActivity(p);
          	    	    Downloader.this.finish();
          	    		break;
          	    	case 8:
            ...
            case GEN2CUSTOM:
                ...
                builder1.setMessage(Html.fromHtml("<b>Size:</b> ?????MB<br /><b>Recovery:</b> ClockworkMod v5.0.2.0<br /><b>Splash:</b> Normal Android<br /><b>Fastboot:</b> Enabled on vol+"));
            ...
            case GEN2CUSTOMB:
                ...
                builder2.setMessage(Html.fromHtml("<b>Size:</b> ?????MB<br /><b>Recovery:</b> ClockworkMod v5.0.2.0<br /><b>Splash:</b> Normal Android<br /><b>Fastboot:</b> Enabled on vol+"));
            ...
            case GEN2STOCK:
                ...
                builder3.setMessage(Html.fromHtml("<b>Size:</b> ?????MB<br /><b>Recovery:</b> ClockworkMod v5.0.2.0<br /><b>Splash:</b> Normal Android<br /><b>Fastboot:</b> Enabled on vol+"));
