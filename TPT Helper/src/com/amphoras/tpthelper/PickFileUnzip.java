            	...
            	public void onClick(DialogInterface dialog, int item) {
        	    	...
        	    	case 6:
        	    		if (mmhmp7.canRead() == true){
        	    		    Editor edit = preferences.edit();
        	    			edit.putString("zipname", "/Gen1-to-Gen2-TPT-MMHMP-RLS7.zip");
        	    			edit.commit();
        	    	        Intent i = new Intent(PickFileUnzip.this, Unzipper.class);
        	    	        startActivity(i);
        	    	        PickFileUnzip.this.finish();
        	    			...
        	    			if (downloadmmhmp7.canRead() == true){
            	    	        Editor edit = preferences.edit();
            	    		    edit.putString("zipname", "/download/Gen1-to-Gen2-TPT-MMHMP-RLS7.zip");
            	    			edit.commit();
            	    	        Intent i = new Intent(PickFileUnzip.this, Unzipper.class);
            	    	        startActivity(i);
            	    	        PickFileUnzip.this.finish();
        	    	...
        	    	case 7:
        	    		if (fnc3.canRead() == true){
        	    		    Editor edit = preferences.edit();
        	    			edit.putString("zipname", "/Gen1-to-Gen2-TPT-FNC-RLS3.zip");
        	    			edit.commit();
        	    	        Intent i = new Intent(PickFileUnzip.this, Unzipper.class);
        	    	        startActivity(i);
        	    	        PickFileUnzip.this.finish();
        	    			...
        	    			if (downloadfnc3.canRead() == true){
            	    	        Editor edit = preferences.edit();
            	    		    edit.putString("zipname", "/download/Gen1-to-Gen2-TPT-FNC-RLS3.zip");
            	    			edit.commit();
            	    	        Intent i = new Intent(PickFileUnzip.this, Unzipper.class);
            	    	        startActivity(i);
            	    	        PickFileUnzip.this.finish();
