...
public class PickFileUnzipGen3 extends Activity {
	...
	protected Dialog onCreateDialog(int id) {
        switch (id) {
        case PICK_FILE:
            Builder builder1 = new AlertDialog.Builder(PickFileUnzipGen3.this);
            	...
            	public void onClick(DialogInterface dialog, int item) {
        	    	...
        	    	case 0:
        	    		if (gen3v1a.canRead() == true){
        	    			...
        	    			edit.commit();
        	    	        Intent i = new Intent(PickFileUnzipGen3.this, Unzipper.class);
        	    	        startActivity(i);
        	    	        PickFileUnzipGen3.this.finish();
        	    		} else {
        	    	...
        	    	case 2:
        	    		...
        	    		break;
        	    	case 3:
        	    		Intent i = new Intent(PickFileUnzipGen3.this, EnterFileUnzip.class);
        ...
        case FILE_UNFOUND:
        	...
        	Builder builder2 = new AlertDialog.Builder(PickFileUnzipGen3.this);
            ...
            builder2.setPositiveButton(R.string.yes, new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog, int id) {
              	    Intent i = new Intent(PickFileUnzipGen3.this, DownloaderGen3.class);
              	    startActivity(i);
              	    PickFileUnzipGen3.this.finish();
                }
            });
