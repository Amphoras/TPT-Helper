...
public class PickFileUnzipGen2 extends Activity {
	...
	protected Dialog onCreateDialog(int id) {
        switch (id) {
        case PICK_FILE:
            Builder builder1 = new AlertDialog.Builder(PickFileUnzipGen2.this);
            	...
            	public void onClick(DialogInterface dialog, int item) {
        	    	...
        	    	case 0:
        	    		if (gen2v1a.canRead() == true){
        	    			...
        	    			edit.commit();
        	    	        Intent i = new Intent(PickFileUnzipGen2.this, Unzipper.class);
        	    	        startActivity(i);
        	    	...
        	    	case 2:
        	    		...
        	    		break;
        	    	case 3:
        	    		Intent i = new Intent(PickFileUnzipGen2.this, EnterFileUnzip.class);
        ...
        case FILE_UNFOUND:
        	...
        	Builder builder2 = new AlertDialog.Builder(PickFileUnzipGen2.this);
