      	  ...
      	  localebuilder.setItems(locales, new DialogInterface.OnClickListener() {
      	    public void onClick(DialogInterface dialog, int item) {
      	    	...
      	    	case 12:
      	    		...
      	    		editlocale.commit();
      	    		Intent u = new Intent(Instructions.this, HomeActivity.class);
      	    	    startActivity(u);
      	    	    Instructions.this.finish();
      	    		break;
      	    	case 13:
      	    		...
      	    		editlocale.commit();
      	    		Intent v = new Intent(Instructions.this, HomeActivity.class);
      	    	    startActivity(v);
      	    	    Instructions.this.finish();
      	    		break;
      	    	case 14:
      	    		...
      	    		editlocale.commit();
      	    		Intent w = new Intent(Instructions.this, HomeActivity.class);
      	    	    startActivity(w);
      	    	    Instructions.this.finish();
      	    		break;
      	    	case 15:
      	    		...
      	    		editlocale.commit();
      	    		Intent x = new Intent(Instructions.this, HomeActivity.class);
      	    	    startActivity(x);
      	    	    Instructions.this.finish();
      	    		break;
      	    	case 16:
