...
public class DownloaderSF2 extends ListActivity {
          	  ...
          	  localebuilder.setItems(locales, new DialogInterface.OnClickListener() {
          	    public void onClick(DialogInterface dialog, int item) {
          	    	...
          	    	case 0:
          	    		...
          	    		editlocale.commit();
          	    		Intent i = new Intent(DownloaderSF2.this, HomeActivity.class);
          	    	    startActivity(i);
          	    	    DownloaderSF2.this.finish();
          	    		break;
          	    	case 1:
          	    		...
          	    		editlocale.commit();
          	    		Intent j = new Intent(DownloaderSF2.this, HomeActivity.class);
          	    	    startActivity(j);
          	    	    DownloaderSF2.this.finish();
          	    		break;
          	    	case 2:
          	    		...
          	    		editlocale.commit();
          	    		Intent k = new Intent(DownloaderSF2.this, HomeActivity.class);
          	    	    startActivity(k);
          	    	    DownloaderSF2.this.finish();
          	    		break;
          	    	case 3:
          	    		...
          	    		editlocale.commit();
          	    		Intent l = new Intent(DownloaderSF2.this, HomeActivity.class);
          	    	    startActivity(l);
          	    	    DownloaderSF2.this.finish();
          	    		break;
          	    	case 4:
          	    		...
          	    		editlocale.commit();
          	    		Intent m = new Intent(DownloaderSF2.this, HomeActivity.class);
          	    	    startActivity(m);
          	    	    DownloaderSF2.this.finish();
          	    		break;
          	    	case 5:
          	    		...
          	    		editlocale.commit();
          	    		Intent n = new Intent(DownloaderSF2.this, HomeActivity.class);
          	    	    startActivity(n);
          	    	    DownloaderSF2.this.finish();
          	    		break;
          	    	case 6:
          	    		...
          	    		editlocale.commit();
          	    		Intent o = new Intent(DownloaderSF2.this, HomeActivity.class);
          	    	    startActivity(o);
          	    	    DownloaderSF2.this.finish();
          	    		break;
          	    	case 7:
          	    		...
          	    		editlocale.commit();
          	    		Intent p = new Intent(DownloaderSF2.this, HomeActivity.class);
          	    	    startActivity(p);
          	    	    DownloaderSF2.this.finish();
          	    		break;
          	    	case 8:
          	    	...
          	    	case 9:
          	    		...
          	    		editlocale.commit();
          	    		Intent r = new Intent(DownloaderSF2.this, HomeActivity.class);
          	    	    startActivity(r);
          	    	    DownloaderSF2.this.finish();
          	    		break;
          	    	case 10:
          	    	...
          	    	case 11:
          	    		...
          	    		editlocale.commit();
          	    		Intent t = new Intent(DownloaderSF2.this, HomeActivity.class);
          	    	    startActivity(t);
          	    	    DownloaderSF2.this.finish();
          	    		break;
          	    	case 12:
          	    		...
          	    		editlocale.commit();
          	    		Intent u = new Intent(DownloaderSF2.this, HomeActivity.class);
          	    	    startActivity(u);
          	    	    DownloaderSF2.this.finish();
          	    		break;
          	    	case 13:
          	    		...
          	    		editlocale.commit();
          	    		Intent v = new Intent(DownloaderSF2.this, HomeActivity.class);
          	    	    startActivity(v);
          	    	    DownloaderSF2.this.finish();
          	    		break;
          	    	case 14:
          	    		...
          	    		editlocale.commit();
          	    		Intent w = new Intent(DownloaderSF2.this, HomeActivity.class);
          	    	    startActivity(w);
          	    	    DownloaderSF2.this.finish();
          	    		break;
          	    	case 15:
          	    		...
          	    		editlocale.commit();
          	    		Intent x = new Intent(DownloaderSF2.this, HomeActivity.class);
          	    	    startActivity(x);
          	    	    DownloaderSF2.this.finish();
          	    		break;
          	    	case 16:
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.locale:
			...
			break;
		case R.id.about:
			Intent j = new Intent(DownloaderSF2.this, About.class);
			startActivity(j);
			break;
		case R.id.instructions:
			Intent k = new Intent(DownloaderSF2.this, Instructions.class);
			startActivity(k);
			break;
		case R.id.show_changelog:
			Intent l = new Intent(DownloaderSF2.this, Changelog.class);
			startActivity(l);
			break;
		case R.id.preferences:
			Intent m = new Intent(DownloaderSF2.this, Preferences.class);
			startActivity(m);
			break;
		case R.id.license:
			Intent n = new Intent(DownloaderSF2.this, License.class);
			startActivity(n);
			break;
		case R.id.rate:
