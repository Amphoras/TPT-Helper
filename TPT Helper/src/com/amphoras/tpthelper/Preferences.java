      	  ...
      	  localebuilder.setItems(locales, new DialogInterface.OnClickListener() {
      	    public void onClick(DialogInterface dialog, int item) {
      	    	...
      	    	case 9:
      	    		...
      	    		editlocale.commit();
      	    		Intent r = new Intent(Preferences.this, HomeActivity.class);
      	    	    startActivity(r);
      	    	    Preferences.this.finish();
      	    		break;
      	    	case 10:
      	    	...
      	    	case 11:
      	    		...
      	    		editlocale.commit();
      	    		Intent t = new Intent(Preferences.this, HomeActivity.class);
      	    	    startActivity(t);
      	    	    Preferences.this.finish();
      	    		break;
      	    	case 12:
      	    		...
      	    		editlocale.commit();
      	    		Intent u = new Intent(Preferences.this, HomeActivity.class);
      	    	    startActivity(u);
      	    	    Preferences.this.finish();
      	    		break;
      	    	case 13:
      	    		...
      	    		editlocale.commit();
      	    		Intent v = new Intent(Preferences.this, HomeActivity.class);
      	    	    startActivity(v);
      	    	    Preferences.this.finish();
      	    		break;
      	    	case 14:
      	    		...
      	    		editlocale.commit();
      	    		Intent w = new Intent(Preferences.this, HomeActivity.class);
      	    	    startActivity(w);
      	    	    Preferences.this.finish();
      	    		break;
      	    	case 15:
      	    		...
      	    		editlocale.commit();
      	    		Intent x = new Intent(Preferences.this, HomeActivity.class);
      	    	    startActivity(x);
      	    	    Preferences.this.finish();
      	    		break;
      	    	case 16:
