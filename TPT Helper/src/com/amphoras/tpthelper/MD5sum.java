...
public class MD5sum extends Activity {
      	  ...
      	  localebuilder.setItems(locales, new DialogInterface.OnClickListener() {
      	    public void onClick(DialogInterface dialog, int item) {
      	    	...
      	    	case 9:
      	    		...
      	    		editlocale.commit();
      	    		Intent r = new Intent(MD5sum.this, HomeActivity.class);
      	    	    startActivity(r);
      	    	    MD5sum.this.finish();
      	    		break;
      	    	case 10:
      	    	...
      	    	case 11:
      	    		...
      	    		editlocale.commit();
      	    		Intent t = new Intent(MD5sum.this, HomeActivity.class);
      	    	    startActivity(t);
      	    	    MD5sum.this.finish();
      	    		break;
      	    	case 12:
      	    		...
      	    		editlocale.commit();
      	    		Intent u = new Intent(MD5sum.this, HomeActivity.class);
      	    	    startActivity(u);
      	    	    MD5sum.this.finish();
      	    		break;
      	    	case 13:
      	    		...
      	    		editlocale.commit();
      	    		Intent v = new Intent(MD5sum.this, HomeActivity.class);
      	    	    startActivity(v);
      	    	    MD5sum.this.finish();
      	    		break;
      	    	case 14:
      	    		...
      	    		editlocale.commit();
      	    		Intent w = new Intent(MD5sum.this, HomeActivity.class);
      	    	    startActivity(w);
      	    	    MD5sum.this.finish();
      	    		break;
      	    	case 15:
      	    		...
      	    		editlocale.commit();
      	    		Intent x = new Intent(MD5sum.this, HomeActivity.class);
      	    	    startActivity(x);
      	    	    MD5sum.this.finish();
      	    		break;
      	    	case 16:
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		/* case R.id.troubleshooting:
			Intent j = new Intent(MD5sum.this, Troubleshooting.class);
			startActivity(j);
			break; */
		case R.id.locale:
